                ...
                <div class="col">
                    <div class="product-tab-menu mb-40 mb-xs-20">
                        <ul class="nav d-flex align-items-center">
                            <li><a class="active" data-toggle="tab" href="#products">Bán chạy</a></li>
                                            ...
                                            <div class="single-product mb-30">
                                                <div class="product-img">
                                                    ...
                                                    <div class="product-action d-flex justify-content-between">
                                                        <a class="product-btn" href="#">Thêm vào giỏ hàng</a>
                                                        <ul class="d-flex">
                    ...
                    <ItemTemplate>
                        <div class="col-md-4 mb-4">
                            <div class="card" style="width: 18rem;">
                               ...
                               <asp:Button ID="btnReadMore" CssClass="template-btn" Text="Xem thêm" runat="server" PostBackUrl='<%# "~/ChiTietBlog.aspx?id=" + Eval("id") %>' />
                            </div>
                        </div>
                    </ItemTemplate>
                </asp:DataList>
